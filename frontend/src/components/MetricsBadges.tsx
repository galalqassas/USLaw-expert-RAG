  ...
  return (
    <div className="flex gap-3 mb-5" data-testid="metrics-badges">
      <span className="px-3 py-1.5 text-xs font-medium bg-background border border-border rounded-full text-secondary-text">
        {UI_TEXT.RETRIEVAL_LABEL}: <span className="text-success font-semibold" data-testid="retrieval-time">{metrics.retrievalTimeMs}ms</span>
      </span>
      <span className="px-3 py-1.5 text-xs font-medium bg-background border border-border rounded-full text-secondary-text">
        {UI_TEXT.SYNTHESIS_LABEL}: <span className="text-warning font-semibold" data-testid="synthesis-time">{metrics.synthesisTimeMs}ms</span>
      </span>
    </div>
  );
}
